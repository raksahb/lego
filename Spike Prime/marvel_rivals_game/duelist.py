...
BASE_HEALTH = 3
BOOSTED_SPEED = 100
BASE_HEALTH_TIMER_THRESHOLD = 60
BOOSTED_HEALTH_TIMER_THRESHOLD = 30
BASE_LIGHT_COLOR = 'white'
HEALTH_LIGHT_COLOR = 'green'
POWER_UP_LIGHT_COLOR = 'red'
...
health_timer_threshold = BASE_HEALTH_TIMER_THRESHOLD
...
while True:
    ...
    if color_detected == POWER_UP_LIGHT_COLOR and not power_up_acquired:
        ...
        health = BASE_HEALTH
        speed = BOOSTED_SPEED
        health_timer_threshold = BOOSTED_HEALTH_TIMER_THRESHOLD
        hub.light_matrix.write(str(health))
